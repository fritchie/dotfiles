...
LS_COLORS="${LS_NORMAL}${LS_FILE}${LS_DIR}${LS_SYMLINK}${LS_PIPE}${LS_SOCKET}${LS_CHAR_DEV}${LS_BLOCK_DEV}${LS_EXECUTABLE}${LS_MISSING_SYMLINK}${LS_ORPHAN_SYMLINK}${LS_SUID}${LS_SGID}${LS_STICKY}${LS_OTHER_WRITEABLE}${LS_STICKY_DIR_OTHER_WRITABLE}${LS_GZIP}"
export LS_COLORS
